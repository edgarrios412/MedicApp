...
const ExamenDetail = ({ navigation }) => {
  return (
    <ScrollView style={tw`bg-[#f2f5ff] h-100%`}>
        ...
        <View style={tw`bg-white rounded-lg shadow-sm p-6 mb-6 w-full`}>
          ...
          <View style={tw`flex-col gap-4 my-4`}>
            <View style={tw`flex-row gap-0 items-center`}>
              ...
              <View>
                <Text style={tw`text-[#222B45] font-bold`}>
                  Revisión preventiva
                </Text>
      ...
      <TouchableOpacity
        onPress={() => navigation.navigate("SecureDownload")}
        style={tw`bg-green-600 mb-6 mx-6 h-14 rounded-xl flex-row items-center`}
      >
